...
for i in range(len(pot_dur_swm)):
    ...
    for k in range(len(skillmods)):
        spills_swm_pot[k,i] = np.count_nonzero(swm_tst_arr_skilltrn[k,3,sset_idx])
        spillvol_swm_pot[k,i] = np.sum(swm_tst_arr_skilltrn[k,3,sset_idx])
        Rmx_swm_pot[k,i] = np.max(swm_tst_arr_skilltrn[k,1,sset_idx])
        Rmn_swm_pot[k,i] = np.mean(swm_tst_arr_skilltrn[k,1,sset_idx])
        fovg_swm_pot[k,i] = np.max(swm_tst_arr_skilltrn[k,8,sset_idx])
...
for i in range(len(pot_dur_swmcc)):
    ...
    #pks_swm[i] = min(np.sum(pks_ind>0),np.sum(pks_ind<0))
    for k in range(len(skillmods)):
        spills_swmcc_pot[k,i] = np.count_nonzero(swmcc_tst_arr_skilltrn[k,3,sset_idx])
        spillvol_swmcc_pot[k,i] = np.sum(swmcc_tst_arr_skilltrn[k,3,sset_idx])
        Rmx_swmcc_pot[k,i] = np.max(swmcc_tst_arr_skilltrn[k,1,sset_idx])
        Rmn_swmcc_pot[k,i] = np.mean(swmcc_tst_arr_skilltrn[k,1,sset_idx])
        fovg_swmcc_pot[k,i] = np.max(swmcc_tst_arr_skilltrn[k,8,sset_idx])
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[0]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[1]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[2]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[3]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[0]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[1]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[2]),fontsize='medium')
...
ax1.text(6,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[3]),fontsize='medium')
...
ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'a)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[0]),fontsize='medium')
...
#ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'b)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[1]),fontsize='medium')
...
#ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'d)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[3]),fontsize='medium')
...
ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'e)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[0]),fontsize='medium')
...
#ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'f)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[1]),fontsize='medium')
...
#ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'g)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[2]),fontsize='medium')
...
#ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'h)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm4C}$' %(skillmods[3]),fontsize='medium')
...
fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x4_magnitude-nopeaks-Rmax-skilltrn_use-firo-top=%s_use-firo-bottom=%s_seed-%s_evt=%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,evt_no,str(skillmods),skill_dcy,skill_tail,swm_ind,same_swm,yr_cutoff),dpi=300,bbox_inches='tight')
...
fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x4_magnitude-duration-fovg-skilltrn_use-firo-top=%s_use-firo-bottom=%s_seed-%s_evt=%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,evt_no,str(skillmods),skill_dcy,skill_tail,swm_ind,same_swm,yr_cutoff),dpi=300,bbox_inches='tight')
...
#ax1.set_ylabel('Peak flow (TAF/d)')
ax1.text(1,1100,'c)',fontsize='xx-large',fontweight='bold')
ax1.text(3,1100,'$CRPS-SS_{train}=%s_{swm}$' %(skillmods[2]),fontsize='medium')
ax1.text(3,1000,'$CRPS-SS_{test}=%s_{swm}$' %(skillmods[2]),fontsize='medium')
#ax1.set_title('$CRPS-SS_{train}=0.0_{swm};\ CRPS-SS_{test}=0.8_{swm}$')
#plt.colorbar(label='$R_{max}\ (TAF/d)$',orientation='vertical')
#plt.legend(['$swm$','$swm_{4C}$'],loc='upper left',fontsize='large',title_fontsize='large',frameon=False)
...
fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x4_magnitude-nopeaks-fovg-skilltrn_use-firo-top=%s_use-firo-bottom=%s_seed-%s_evt=%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,evt_no,str(skillmods),skill_dcy,skill_tail,swm_ind,same_swm,yr_cutoff),dpi=300,bbox_inches='tight')
