...
if(idx==1){
  ...
  saveRDS(synq_sim_arr,paste('./out/swm/synq_sim_arr_use-bcf=',use_bcf,'_k=',kk,'.rds',sep=''))
  ...
  saveRDS(ann_max_stoch_arr,paste('./out/swm/synq_annmax_use-bcf=',use_bcf,'_k=',kk,'.rds',sep=''))
  ...
  saveRDS(synq_sim_arr,paste('./out/swm/synq_arr_fit_use-bcf=',use_bcf,'_k=',kk,'.rds',sep=''))
  ...
  saveRDS(ann_max_stoch_arr,paste('./out/swm/synq_annmax_fit_use-bcf=',use_bcf,'_k=',kk,'.rds',sep=''))
...
if(idx==2){
  ...
  saveRDS(synq_sim_arr_cc,paste('./out/swm/synq_sim_arr_cc_use-bcf=',use_bcf,'_k=',kk,'.rds',sep=''))
  ...
  saveRDS(ann_max_stoch_arr,paste('./out/swm/synq_annmax_cc_use-bcf=',use_bcf,'_k=',kk,'.rds',sep=''))
