...
#/////////////////////////////////////////////////////////////////////////////////////////////////////////////
#.............................................................................................................
#Plot 1: FIRO pool overage w/ and w/o FIRO pool flexibility and w/ and w/o CC
#Event based metrics
#panel 1
swm_ind = 'swm'
nb = len(skillmods)
...
syn_util.fig_title(fig,'FIRO Pool Overages (Top %s events)' %(n_evts),loc=(0.45,1.),fontsize='xx-large',fontweight='bold',rotation=0,ha='center',va='center')
...
fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x2_event-based-firo-overage-comparison_use-firo-top=%s_use-firo-bottom=%s_seed-%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_nevts=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,skillmods,skill_dcy,skill_tail,swm_ind,same_swm,n_evts,yr_cutoff),dpi=300,bbox_inches='tight')


#.............................................................................................................
#Plot 2: Max ramping rate w/ and w/o FIRO pool flexibility and w/ and w/o CC
#Event based metrics
#panel 1
swm_ind = 'swm'
nb = len(skillmods)

ylm = ([0,1.05*ramping_rate_up])
xlm = ([0.5,nb+0.5])
upperq = 0.99
lowerq = 0.01
use_err = True
ref_line1 = ramping_rate_down
ref_line2 = ramping_rate_up

inp1 = swm_tst_metrics[5,:,:]
inp2 = swm_tst_metrics_skilltrn[5,:,:]
...
#l2, = ax1.plot(0,0,color=cb_grn,linestyle='--',linewidth=1)
#ax1.legend([l1,l2],['K','WCM Apr 1 limit'],loc='upper left',fontsize='small',frameon=False)
ax1.set_ylabel('Ramping rate (TAF/d)',fontsize='large')
ax1.axhline(ref_line1,color=cb_gry,linestyle='--',linewidth=1)
ax1.axhline(ref_line2,color='red',linestyle='--',linewidth=1)
#ax1.set_xticks(ticks=(x1+0.2))
#ax1.xaxis.set_ticklabels(['0','0.4','0.8'])
ax1.xaxis.set_ticklabels([])
ax1.tick_params(axis='both',which='major',labelsize='large')
...
inp1 = swm_tstfpool_metrics[5,:,:]
inp2 = swm_tstfpool_metrics_skilltrn[5,:,:]
...
inp1 = swmcc_tst_metrics[5,:,:]
inp2 = swmcc_tst_metrics_skilltrn[5,:,:]
...
inp1 = swmcc_tstfpool_metrics[5,:,:]
inp2 = swmcc_tstfpool_metrics_skilltrn[5,:,:]
...
syn_util.fig_title(fig,'Maximum Ramping Rates (Top %s events)' %(n_evts),loc=(0.45,1.),fontsize='xx-large',fontweight='bold',rotation=0,ha='center',va='center')
syn_util.fig_title(fig,'Historical',loc=(-0.02,0.725),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')
syn_util.fig_title(fig,'4C Warming',loc=(-0.02,0.275),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')

fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x2_event-based-max-ramping-comparison_use-firo-top=%s_use-firo-bottom=%s_seed-%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_nevts=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,skillmods,skill_dcy,skill_tail,swm_ind,same_swm,n_evts,yr_cutoff),dpi=300,bbox_inches='tight')


#.............................................................................................................
#Plot 2: Post event drawdown w/ and w/o FIRO pool flexibility and w/ and w/o CC
#Event based metrics
#panel 1
swm_ind = 'swm'
nb = len(skillmods)
...
inp1 = swm_tst_metrics[7,:,:]
inp2 = swm_tst_metrics_skilltrn[7,:,:]
...
if use_err == True:
    ax1.bar(x1,y1,color=swm_sk0,width=0.35,yerr=yerr1)
    ax1.bar(x2,y2,color=([swm_sk0,swm_skmod,swm_skhi]),width=0.35,yerr=yerr2)
if use_err == False:
    ax1.bar(x1,y1,color=swm_sk0,width=0.35)
    ax1.bar(x2,y2,color=([swm_skn4,swm_sk0,swm_skmod,swm_skhi]),width=0.35)
ax1.set_title('Fixed FIRO pool',fontsize='large')
...
#l2, = ax1.plot(0,0,color=cb_grn,linestyle='--',linewidth=1)
#ax1.legend([l1,l2],['K','WCM Apr 1 limit'],loc='upper left',fontsize='small',frameon=False)
ax1.set_ylabel('Drawdown (TAF)',fontsize='large')
#ax1.axhline(ref_line,color=cb_brwn,linestyle='--',linewidth=1)
#ax1.set_xticks(ticks=(x1+0.2))
#ax1.xaxis.set_ticklabels(['0','0.4','0.8'])
ax1.xaxis.set_ticklabels([])
...
inp1 = swm_tstfpool_metrics[7,:,:]
inp2 = swm_tstfpool_metrics_skilltrn[7,:,:]
...
inp1 = swmcc_tst_metrics[7,:,:]
inp2 = swmcc_tst_metrics_skilltrn[7,:,:]
...
inp1 = swmcc_tstfpool_metrics[7,:,:]
inp2 = swmcc_tstfpool_metrics_skilltrn[7,:,:]
...
l4, = ax1.bar(x2[2],y2[2],color=swmcc_skmod,width=0.35)
l5, = ax1.bar(x2[3],y2[3],color=swmcc_skhi,width=0.35)
ax1.legend([l1,l2,l3,l4,l5],['$%s_{swm}$' %(skillmods[0]),'$%s_{swm4c}$' %(skillmods[0]),'$%s_{swm4c}$' %(skillmods[1]),'$%s_{swm4c}$' %(skillmods[2]),'$%s_{swm4c}$' %(skillmods[3])],loc='center left',fontsize='large',bbox_to_anchor=(1.0, 0.5),title='$CRPSS-SS_{train}$',title_fontsize='large',frameon=False)
syn_util.fig_title(fig,'Post-event Drawdown below FIRO pool (Top %s events)' %(n_evts),loc=(0.45,1.),fontsize='xx-large',fontweight='bold',rotation=0,ha='center',va='center')
syn_util.fig_title(fig,'Historical',loc=(-0.02,0.725),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')
syn_util.fig_title(fig,'4C Warming',loc=(-0.02,0.275),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')

fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x2_event-based-post-drawdown-comparison_use-firo-top=%s_use-firo-bottom=%s_seed-%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_nevts=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,skillmods,skill_dcy,skill_tail,swm_ind,same_swm,n_evts,yr_cutoff),dpi=300,bbox_inches='tight')


#.............................................................................................................
#Plot 3: Mean ramping rate w/ and w/o FIRO pool flexibility and w/ and w/o CC
#Event based metrics
#panel 1
swm_ind = 'swm'
nb = len(skillmods)

ylm = ([0,1.05*ramping_rate_down])
xlm = ([0.5,nb+0.5])
upperq = 0.9
lowerq = 0.1
use_err = True
ref_line = ramping_rate_down

inp1 = swm_tst_metrics[6,:,:]
inp2 = swm_tst_metrics_skilltrn[6,:,:]
...
#ax1.legend([l1,l2],['K','WCM Apr 1 limit'],loc='upper left',fontsize='small',frameon=False)
ax1.set_ylabel('Ramping rate (TAF/d)',fontsize='large')
ax1.axhline(ref_line,color='red',linestyle='--',linewidth=1)
#ax1.set_xticks(ticks=(x1+0.2))
#ax1.xaxis.set_ticklabels(['0','0.4','0.8'])
ax1.xaxis.set_ticklabels([])
ax1.tick_params(axis='both',which='major',labelsize='large')
...
inp1 = swm_tstfpool_metrics[6,:,:]
inp2 = swm_tstfpool_metrics_skilltrn[6,:,:]
...
inp1 = swmcc_tst_metrics[6,:,:]
inp2 = swmcc_tst_metrics_skilltrn[6,:,:]
...
inp1 = swmcc_tstfpool_metrics[6,:,:]
inp2 = swmcc_tstfpool_metrics_skilltrn[6,:,:]
...
l5, = ax1.bar(x2[3],y2[3],color=swmcc_skhi,width=0.35)
ax1.legend([l1,l2,l3,l4,l5],['$%s_{swm}$' %(skillmods[1]),'$%s_{swm4c}$' %(skillmods[0]),'$%s_{swm4c}$' %(skillmods[1]),'$%s_{swm4c}$' %(skillmods[2]),'$%s_{swm4c}$' %(skillmods[3])],loc='center left',fontsize='large',bbox_to_anchor=(1.0, 0.5),title='$CRPSS-SS_{train}$',title_fontsize='large',frameon=False)
syn_util.fig_title(fig,'Mean Ramping Rates (Top %s events)' %(n_evts),loc=(0.45,1.),fontsize='xx-large',fontweight='bold',rotation=0,ha='center',va='center')
syn_util.fig_title(fig,'Historical',loc=(-0.02,0.725),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')
syn_util.fig_title(fig,'4C Warming',loc=(-0.02,0.275),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')

fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x2_event-based-mean-ramping-comparison_use-firo-top=%s_use-firo-bottom=%s_seed-%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_nevts=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,skillmods,skill_dcy,skill_tail,swm_ind,same_swm,n_evts,yr_cutoff),dpi=300,bbox_inches='tight')


#.............................................................................................................
#Plot 5: Cumulative post event drawdown w/ and w/o FIRO pool flexibility and w/ and w/o CC
#Event based metrics
#panel 1
swm_ind = 'swm'
nb = len(skillmods)
...
inp1 = swm_tst_metrics[8,:,:]
inp2 = swm_tst_metrics_skilltrn[8,:,:]
...
#l2, = ax1.plot(0,0,color=cb_grn,linestyle='--',linewidth=1)
#ax1.legend([l1,l2],['K','WCM Apr 1 limit'],loc='upper left',fontsize='small',frameon=False)
ax1.set_ylabel('Cumulative Drawdown (TAF)',fontsize='large')
#ax1.axhline(ref_line,color=cb_brwn,linestyle='--',linewidth=1)
#ax1.set_xticks(ticks=(x1+0.2))
#ax1.xaxis.set_ticklabels(['0','0.4','0.8'])
ax1.xaxis.set_ticklabels([])
...
inp1 = swm_tstfpool_metrics[8,:,:]
inp2 = swm_tstfpool_metrics_skilltrn[8,:,:]
...
inp1 = swmcc_tst_metrics[8,:,:]
inp2 = swmcc_tst_metrics_skilltrn[8,:,:]
...
inp1 = swmcc_tstfpool_metrics[8,:,:]
inp2 = swmcc_tstfpool_metrics_skilltrn[8,:,:]
...
syn_util.fig_title(fig,'Post-event Cumulative Drawdown (Top %s events)' %(n_evts),loc=(0.5,1.),fontsize='xx-large',fontweight='bold',rotation=0,ha='center',va='center')
syn_util.fig_title(fig,'Historical',loc=(-0.02,0.725),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')
syn_util.fig_title(fig,'4C Warming',loc=(-0.02,0.275),fontsize='xx-large',fontweight='bold',rotation=90,ha='center',va='center')

fig.savefig('e:/Projects/FIRO/firo_syn-forecast_stochastic-CC/figs/ops_plots/2x2_event-based-post-drawdown-cumul-comparison_use-firo-top=%s_use-firo-bottom=%s_seed-%s_mods=%s_dcy=%s_tail=%s_swm=%s_same-swm=%s_nevts=%s_cutoff=%s.png' %(use_firo_top,use_firo_bottom,seed,skillmods,skill_dcy,skill_tail,swm_ind,same_swm,n_evts,yr_cutoff),dpi=300,bbox_inches='tight')
